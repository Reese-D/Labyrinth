...
{
	fprintf(stderr, "I have been called\n");
}

void TheButtonCallback2()
{
	fprintf(stderr, "I have been called 2\n");
}
...
Button Button1 = {240, 32, 160, 32, 0,0, "Button1", TheButtonCallback };
Button Button2 = {240, 96, 160, 32, 0, 0, "Button2", TheButtonCallback2};
Button Button3 = {240, 160, 160, 32, 0,0, "Button3", TheButtonCallback };
Button Button4 = {240, 224, 160, 32, 0, 0, "Button4", TheButtonCallback2};
Button Button5 = {240, 288, 160, 32, 0,0, "Button5", TheButtonCallback };
Button Button6 = {240, 352, 160, 32, 0, 0, "Button6", TheButtonCallback2};
...
void Resize(int w, int h)
{
	...
	Button1.w = w/4;
	Button1.h = h/15;
	Button1.x = w/2 - Button1.w/2;
	Button1.y = h/15;


	Button2.w = w/4;
	Button2.h = h/15;
	Button2.x = w/2 - Button2.w/2;
	Button2.y = h/15 * 3;

	Button3.w = w/4;
	Button3.h = h/15;
	Button3.x = w/2 - Button2.w/2;
	Button3.y = h/15 * 5;

	Button4.w = w/4;
	Button4.h = h/15;
	Button4.x = w/2 - Button2.w/2;
	Button4.y = h/15 * 7;

	Button5.w = w/4;
	Button5.h = h/15;
	Button5.x = w/2 - Button2.w/2;
	Button5.y = h/15 * 9;

	Button6.w = w/4;
	Button6.h = h/15;
	Button6.x = w/2 - Button2.w/2;
	Button6.y = h/15 * 11;
...
void MouseButton(int button,int state,int x, int y)
{
	...
	if (state == GLUT_DOWN)
	{
		...
		case GLUT_LEFT_BUTTON:
			...
			ButtonPress(&Button3,x,y);
			ButtonPress(&Button4,x,y);
			ButtonPress(&Button5,x,y);
			ButtonPress(&Button6,x,y);
	...
	else
	{
		...
		case GLUT_LEFT_BUTTON:
			TheMouse.lmb = 0;
			ButtonRelease(&Button1,x,y);
			ButtonRelease(&Button2,x,y);
			ButtonRelease(&Button3,x,y);
			ButtonRelease(&Button4,x,y);
			ButtonRelease(&Button5,x,y);
			ButtonRelease(&Button6,x,y);
			break;
		case GLUT_MIDDLE_BUTTON:
			TheMouse.mmb = 0;
			break;
...
void MouseMotion(int x, int y)
{
	 ...
	 */
	ButtonPassive(&Button1,x,y);
	ButtonPassive(&Button2,x,y);
	ButtonPassive(&Button3,x,y);
	ButtonPassive(&Button4,x,y);
	ButtonPassive(&Button5,x,y);
	ButtonPassive(&Button6,x,y);
...
void createMenu(){
	...
	glutAddMenuEntry("MenuItem1", 1);
	glutAddMenuEntry("MenuItem2", 2);

	int sub2 = glutCreateMenu(menu);
	glutAddMenuEntry("MenuItem3", 3);
	glutAddMenuEntry("MenuItem4", 4);

	int subMain = glutCreateMenu(menu);
